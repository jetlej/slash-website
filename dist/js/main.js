$(function() {
  ...
  */
  ...
  function ajaxMailChimpForm($form, $resultElement, action) {
    console.log(action)
    console.log('Valdating the form')
  ...
  function mailchimpSubscribe($form, $resultElement) {
    ...
    $.ajax({
      type: 'GET',
      url:
        'https://getslash.us5.list-manage.com/subscribe/post-json?u=2e58ea2720a92579a1fd9ba6a&amp;id=bda01cf26f',
      data: $form.serialize(),
      cache: false,
      dataType: 'jsonp',
      jsonp: 'c',
...
function changeStep(step) {
  ...
  if (step === 1) {
    $('.app')
      .removeClass('step2 step3 step4 active')
      .addClass('step1')
    setTimeout(() => {
      $('.app').addClass('active')
    }, 500)
  ...
  if (step === 2 || step === 4) {
    ...
    $('.timer').text('0:00')
    $('.app')
      .removeClass('step1 step3 active')
      .addClass('step2')
  ...
  if (step === 3) {
    $('.app')
      .removeClass('step1 step2 step4 active')
      .addClass('step3')
    setTimeout(() => {
      $('.app').addClass('active')
    }, 500)
